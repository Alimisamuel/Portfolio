  ...
  return (
    <>
      <div className="row">
        ...
        {/* onClick={toggleModalOne} */}
          <div className="blog-post" >
            <div className="blog-img">
              ...
              <img src="img/blog/chopstix.jpeg" alt="blog post"></img>
            </div>
            {/* End blog-img */}

            <div className="blog-info">
              <h6>Chopstix: company re-branding</h6>
              <p>
                Rebranded the  company's packaging materials and also promoted and managed the companies social accounts .
              </p>
        ...
        <div className="col-lg-4 col-md-6 my-3">
          ...
          <div className="blog-post" >
            <div className="blog-img">
              ...
              <img src="img/blog/ulego.jpeg" alt="blog post"></img>
            </div>
            {/* End blog-img */}

            <div className="blog-info">
              <h6>Ulego: web design and dev.</h6>
              <p>
                Designed the  UI and built the company's website from scratch 
              </p>
              <div className="btn-bar">Read More</div>
            </div>
            {/* End blog-info */}
        ...
        <div className="col-lg-4 col-md-6 my-3">
        {/* onClick={toggleModalThree}   ----copy this  back to the blog-post div for modal  toggle */}
          <div className="blog-post" >
            <div className="blog-img">
              <div className="data">
                <span>22</span>
              ...
              <img src="img/blog/nupat.png" alt="blog post"></img>
            </div>
            {/* End blog-img */}

            <div className="blog-info">
              <h6>Nupat Dashboard: Web design & dev.</h6>
              <p>
              Designed the  UI and built the company's student  dashboard from scratch
              </p>
              <div className="btn-bar">Read More</div>
            </div>
            {/* End blog-info */}
